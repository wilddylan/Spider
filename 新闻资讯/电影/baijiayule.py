...
def fetchMiaopaiData():
  ...
  f1 = open("/app/yxtk/script/data/baijiayule.sql",'w',buffering=-1)
  ...
  headers = {
             ...
             'Host':'http://baijia.baidu.com/?tn=listarticle&labelid=4',
             'Referer':'http://baijia.baidu.com/?tn=listarticle&labelid=4',
  ...
  while True:
      for j in range(1,4):
          time.sleep(1)
          if j == 1:
            url='http://baijia.baidu.com/?tn=listarticle&labelid=4'
          if j == 2:
            url='http://baijia.baidu.com/?tn=listarticle&labelid=3'
          if j == 3:
            url='http://baijia.baidu.com/?tn=listarticle&labelid=5'
          print url;                                                     
          try:
              ...
              for li in divs.items():
                ...
                title = title.replace(",",'，')
                print title
                pic = li('p.feeds-item-pic').children('a').children('img').attr('src')
                ...
                sql ="INSERT INTO 3rd_tencent_news(id,creator,modifier,create_time,modify_time,is_deleted,title,time,img_url,thumbnail_url,source,content,push_flag,recommend_flag,view_status) VALUES(NULL,'sys','sys',now(),now(),'n'," + title.strip() + ",now(),'" +imageUrl+ "','"+imageUrl+"','百家新闻','"+p.strip()+"',0,NULL,0);"+'\n'
                print sql
                f1.writelines(sql)
